var PARTICLE_QUANT = 20;
var FPS = 60;
var BOUNCE = -5;
var PARTICLE_COLOR = 'black';
var ARC_RADIUS = 4;
...
proto.init = function() {
  ...
  proto.update = function() {
      ...
      for (i = 0; i < l; i++) {
          ...
          ARC_RADIUS = /* Math.random() * (Math.random() * */ 40/* ) */;
      ...
      $("#js-particles").mouseenter(function(event){
          if (Math.round(particle.x) === event.pageX && Math.round(particle.y) === event.pageY){
